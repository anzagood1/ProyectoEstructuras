...
public class ListaEnlazadaDobleCircular <T> implements Iterable<T> {
    ...
    public ListaEnlazadaDobleCircular(Nodo head, Nodo tail){
        this.head = null;
        this.tail = null;
    ...
    public void addFirst(T dato) {
        ...
        if (head == null) {                 // Si la lista está vacía, el nuevo nodo es cabeza y se enlaza a sí mismo
            ...
            nuevoNodo.previous = tail;        // El nuevo nodo apunta a la antigua cola
            tail.next = nuevoNodo;       // La cola apunta al nuevo nodo
